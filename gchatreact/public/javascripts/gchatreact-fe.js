...
var GChatBoxUI = React.createClass({
    ...
    displayMessage: function(sd){
        if (typeof sd.msgtype !== 'undefined') {
            ...
            this.state.data.push({username: sd.uname, avatar: sd.avatar, message: sd.msg, timesent: sendtime , msgtype: sd.msgtype, msgvisible: true});
            this.setState({});
        }
        ...
        return (
                <table style={chatui}> 
                    <tr style={channelinfo}>
                        <td style={td1and2}>
                            <p id="textid" style={channelname}>{this.state.channelName}</p>
                        </td>
                    </tr>
                    <tr style={chatbox}>
                        <td style={td1and2}>
...
var ChatMessage = React.createClass({
    render: function () {
        ...
        if (this.props.msgvisible) {
            ...
            if (typeof(this.props.message) !== 'undefined' && this.props.message.length > 39) {
